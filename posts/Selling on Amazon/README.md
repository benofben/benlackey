...
The listing form required a minimum age for the product.  That made a bit of sense as it's a toy, even if it is one adults sometimes play with.  I had rather arbitrarily chosen 120 months.  That was below 12 years, so had triggered the need for some sort of compliance documentation.  

I did a cursory review, realized it was hideously complex and just adjusted the age to 18*12=216 months.  That resolved the issue.
...
It's been a really heavy lift to get listed.  I started work on 7/2.  It's now 8/14.  If JRUCS were my sole livelihood and I was dependent on Amazon as my main channel, this would be a disaster.  
